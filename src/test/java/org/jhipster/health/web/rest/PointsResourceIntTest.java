...
public class PointsResourceIntTest {
    ...
    private static final Integer DEFAULT_CIGARETTE = 1;
    private static final Integer UPDATED_CIGARETTE = 2;
    ...
    public void createPoints() throws Exception {
        ...
        assertThat(testPoints.getCigarette()).isEqualTo(DEFAULT_CIGARETTE);
    ...
    public void updatePoints() throws Exception {
        ...
        assertThat(testPoints.getCigarette()).isEqualTo(UPDATED_CIGARETTE);
